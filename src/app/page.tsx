...
export default function Home() {
  return (
    <div className={styles.container}>
      ...
      <p>
        Helped teams to <strong>deliver 2-3x faster</strong> while <strong>cutting error rates by 50%</strong>. Shipped
        features <strong>used by 300 million monthly users globally</strong> across web, mobile, and smart TV platforms.
        Helped multiple engineers <strong>level up and get promoted</strong> through hands-on{' '}
      ...
      <div className={styles.keywords}>
        ...
        <ul>
          ...
          <li>
            <strong>Skills:</strong> Team Leadership, Web Development, Product Engineering, Process Automation, Project
          ...
          <li>
            ...
            Sentry, RUM, Jest, vitest, Notion, Figma, TS, JS, SVG, Leaflet, OpenAPI, Puppeteer, PhantomJS, SVG, VML, A/B
            testing, Angular, GraphQL
          </li>
        </ul>
      </div>
    </div>
